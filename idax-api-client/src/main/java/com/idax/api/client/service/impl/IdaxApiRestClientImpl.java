...
import com.idax.api.client.util.BeanUtil;
import com.idax.api.client.util.CheckParamValidUtil;
import com.idax.api.client.util.ObjectUtils;
import com.idax.api.client.util.SignUtils;
import com.idax.api.client.util.http.HttpRest;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static com.idax.api.client.constant.IdaxApiConstants.*;
...
public class IdaxApiRestClientImpl implements IdaxApiRestClient {
    ...
    public OrderBookEntry getOrderBook(String symbol) {
        ...
        String url = apiBaseUrl + URL_DEPTH.replace("#{symbol}", symbol);
    ...
    public TickerEntry getTickerEntry(String symbol) {
        ...
        String url = apiBaseUrl + URL_TICKER.replace("#{symbol}", symbol);
    ...
    public KlineEntry getKlineEntry(KlineRequest kLineReuest) {
        ...
        return new HttpRest<KlineEntry>().get(apiBaseUrl + URL_K_LINE, param, KlineEntry.class);
    ...
    public TradeEntry getTradeEntry(String symbol) {
        ...
        String url = apiBaseUrl + URL_TRADE.replace("#{symbol}", symbol);
    ...
    public PairEntry getPairEntry() {
        ...
        return new HttpRest<PairEntry>().get(apiBaseUrl + URL_PAIR, PairEntry.class);
    }
    ...
    public PairLimitEntry getPairLimitEntry(String symbol) {
        ...
        String url = apiBaseUrl + URL_PAIR_LIMIT.replace("#{symbol}", symbol);
...
//    }
    ...
    public OrderInfoEntry getOrderInfo(OrderInfoRequest orderInfoRequest) {
        ...
        return new HttpRest<OrderInfoEntry>().post(apiBaseUrl + URL_ORDER_INFO, orderInfoRequest, OrderInfoEntry.class);
    }
    ...
    public OrderHistoryEntry getOrderHistory(OrderHistoryRequest orderHistoryRequest) {
        ...
        return new HttpRest<OrderHistoryEntry>().post(apiBaseUrl + URL_ORDER_HISTORY, orderHistoryRequest, OrderHistoryEntry.class);
    }
    ...
    public UserInfoEntry getUserInfo(UserInfoRequest userInfoRequest) {
        ...
        return new HttpRest<UserInfoEntry>().post(apiBaseUrl + URL_USER_INFO, userInfoRequest, UserInfoEntry.class);
    }
...
//    }
    ...
    public MyTradesEntry getMyTrades(MyTradesRequest myTradesRequest){
        ...
        return new HttpRest<MyTradesEntry>().post(apiBaseUrl + URL_MY_TRADES, myTradesRequest,MyTradesEntry.class);
    }
    ...
    public PlaceOrderEntry placeOrder(PlaceOrderRequest placeOrderRequest) {
        ...
        return new HttpRest<PlaceOrderEntry>().post(apiBaseUrl + URL_PLACE_ORDER, placeOrderRequest, PlaceOrderEntry.class);
    }
    ...
    public CancelOrderEntry cancelOrder(CancelOrderRequest cancelOrderRequest) {
        ...
        return new HttpRest<CancelOrderEntry>().post(apiBaseUrl + URL_CANCEL_ORDER, cancelOrderRequest, CancelOrderEntry.class);
    }

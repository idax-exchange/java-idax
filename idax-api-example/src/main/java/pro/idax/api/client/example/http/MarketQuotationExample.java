...
import pro.idax.api.client.domain.KlineRequest;
import pro.idax.api.client.entry.KlineEntry;
import pro.idax.api.client.entry.OrderBookEntry;
import pro.idax.api.client.entry.TickerEntry;
